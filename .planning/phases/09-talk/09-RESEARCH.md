...
| `src/mcp_connector/tools/talk.py` | NEU. `APP = "spreed"`, `LEVELS = ("conversations", "messages")`, `DEFAULT_LIMIT = 20`, `MAX_LIMIT = 50`, `MAX_CONVERSATIONS = 50`, `MAX_MESSAGE_CHARS`, `KEPT_TYPES`, `browse`, `send`, `_conversation`, `_message`, `_resolve`, `_may_send`, `_rejects_mention_all`, `_envelope` |
