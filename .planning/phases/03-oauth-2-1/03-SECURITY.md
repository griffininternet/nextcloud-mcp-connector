...
| AR-03-08 | WR-12 (Review), berührt T-03-35 | `POST /connect` trägt kein Anti-Fälschungs-Merkmal: eine fremde Seite kann einen Besucher einen Login-Flow anlegen lassen. Kein Credential-Leck, nur erzwungene Zustandserzeugung, seit CR-02 auf 20 je Quelle und fünf Minuten begrenzt. **Weiterhin offen nach dem Phase-4-Review (LO-04), erneut gegen den laufenden Code geprüft:** die Route ist bewusst anonym und gibt nichts heraus, was ein Angreifer lesen kann. Begründungspflichtig ist seit Phase 4 nur die Inkonsistenz zu `/connections`, wo alle fünf Aktionen den Wert tragen | Owner (Review offen gelassen) | 2026-08-17 |
