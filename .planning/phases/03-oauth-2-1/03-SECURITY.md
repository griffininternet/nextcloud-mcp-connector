...
| AR-03-09 | IN-01 bis IN-06 (Review) | Sechs Info-Feststellungen: unerreichbare Cancel-Aktion, `_has_expired` ignoriert die injizierte Uhr, `revocation_endpoint_auth_methods_supported` führt `none` nicht (live bestätigt), zwei Definitionen eines sicheren Client-Namens, Handoff-Link ohne die Hostprüfung der Consent-Seite, ein Kommentar der `compare_digest` überhöht. Keine davon liegt auf einem Verbindungspfad | Owner (Review offen gelassen) | 2026-08-16 |
