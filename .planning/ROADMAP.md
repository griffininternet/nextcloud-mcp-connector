...
- [x] 09-02-PLAN.md: Sechster Admin-Wert: Formular, Overlay-Lesepfad, Manifest-Variable und der Weg in den Tool-Lesepfad
...
- [x] 09-05-PLAN.md: Live-Messung der Nebenwirkungsfreiheit, Senden gegen eine echte Instanz und Zwei-Konten-Negativbeweis
...
- [x] 10-03-PLAN.md: HTML zu Text mit lxml und der dritte Kappungsmarker, der für eine Mail wahr ist
...
- [x] 10-05-PLAN.md: mail: als Id-Kind und der Volltext über das bestehende fetch, mit flachen Vertrauens-Signalen
...
- [x] 11-02-PLAN.md: Die nebenwirkungsfreie Talk-Kontextroute im Client

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 11-03-PLAN.md: fetch löst eine einzelne Talk-Nachricht und eine Tabelle auf
- [x] 11-04-PLAN.md: Talk-Digest im Bündel plus die eine Zeile, die TOOL-16 dort wirksam macht
...
- [x] 11-08-PLAN.md: Abnahmeskript aus der Registry, drei Info-Befunde, drei READMEs
