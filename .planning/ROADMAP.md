...
- [ ] 06-01-PLAN.md , AUTH-09: Groessenlimit-Zwilling und CIMD-Zielpruefung (ohne Netzwerk)
- [ ] 06-03-PLAN.md , CLIENT-05 und AUTH-08: RFC-8252-7.3-Loopback-Regel und CIMD-Schalter

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 06-02-PLAN.md , AUTH-09: gepinnter Abruf, Dokumentvalidierung, Negativkatalog inkl. Rebinding
- [ ] 06-04-PLAN.md , AUTH-08: Advertising im AS-Dokument, Manifest-Deklaration, Verdrahtung

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 06-05-PLAN.md , AUTH-08: Store-Spalten und der CIMD-Zweig in get_client
...
| 6. Härtung, Eigennachweise und Conference-Reife | v1.1 | 0/10 | Planned | - |
