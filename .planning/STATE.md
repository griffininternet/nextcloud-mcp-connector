...
- [Phase ?]: Phase 13 Plan 02: der Issue-Entwurf bleibt eine Datei (docs/contrib/enterprise-signals-issue.md); Veroeffentlichung ist Owner-Entscheidung (D-07), das Go-Kriterium liegt seit Review-Fix WR-03 (f3faefd) intern in .planning/phases/13-cimd-nachmessung-und-release-0-1-9/enterprise-issue-go-kriterium.md, nicht mehr in der oeffentlichen Datei
